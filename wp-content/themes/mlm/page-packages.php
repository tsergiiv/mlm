        ...
        <div class="container">
            <div class="packages-title">
                ...
                <div class="packages-description">
                    Зарегистрируйтесь и получите доступ ко всем инвестиционным пакетам компании UneedHostels
                </div>
            </div>
            ...
            <div class="container">
                <div class="owl-custom-nav dark-nav flex">
                    <div class="hostels-prev flex">
                        <img alt="prev" src="<?php bloginfo('template_url'); ?>/assets/img/slider-arrow.svg">
                    </div>
